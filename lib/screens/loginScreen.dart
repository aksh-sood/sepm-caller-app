                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                TextButton(
                                  onPressed: () async {
                                    var msg;
                                    User user=User.b(phoneOrEmail:phoneOrEmail,password:password);
                                    ...
                                    if(response['success']=='no'){
                                      ...
                                      SecureStorage().saveUserLoginDetails(phoneOrEmail,password);
                                    }
                                    //Fluttertoast.cancel();
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: TextButton(
                                        ...
                                        child:Text(
                                          "Forgot password?",style: kButtonTextStyle,
                                        ),
                                      ),
